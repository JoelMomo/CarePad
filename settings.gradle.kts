...
include(":controls-internal")
project(":controls-internal").projectDir = file("modules/controls/internal")
include(":performance-module")
project(":performance-module").projectDir = file("modules/performance/app")
include(":games-bios-module")
project(":games-bios-module").projectDir = file("modules/games-bios/app")
include(":controls-module")
project(":controls-module").projectDir = file("modules/controls/app")
